...
namespace Integration.Pipeline.CsvToExcelReceiveComponent
{
    ...
    public sealed class CsvToExcelConverterPropertyNameAttribute : Attribute
    {
        private string propertyName;

        public CsvToExcelConverterPropertyNameAttribute(string propertyName)
		{
    ...
    [AttributeUsage(AttributeTargets.All, Inherited = true, AllowMultiple = false)]
    public sealed class CsvToExcelConverterPropertyDescriptionAttribute : Attribute
    {
        private string propertyDescription;

        public CsvToExcelConverterPropertyDescriptionAttribute(string propertyDescription)
        {
    ...
    public class CsvToExcelConverterPropertyDescriptor : PropertyDescriptor
    {
        ...
        public CsvToExcelConverterPropertyDescriptor(PropertyDescriptor descriptor, ResourceManager resourceManager) : base(descriptor)
        {
        ...
        public override string Description
        {
            get
            {
                ...
                CsvToExcelConverterPropertyDescriptionAttribute descriptionAttribute =
                    (CsvToExcelConverterPropertyDescriptionAttribute)attributes[typeof(CsvToExcelConverterPropertyDescriptionAttribute)];
        ...
        public override string DisplayName
        {
            get
            {
                ...
                CsvToExcelConverterPropertyNameAttribute nameAttribute =
                    (CsvToExcelConverterPropertyNameAttribute)attributes[typeof(CsvToExcelConverterPropertyNameAttribute)];
    ...
    public class BaseCustomTypeDescriptor : ICustomTypeDescriptor
    {
        ...
        public virtual PropertyDescriptorCollection GetProperties()
        {
            ...
            CsvToExcelConverterPropertyDescriptor[] bteProperties = new CsvToExcelConverterPropertyDescriptor[srcProperties.Count];

            int i = 0;
            foreach (PropertyDescriptor srcDescriptor in srcProperties)
            {
                CsvToExcelConverterPropertyDescriptor destDescriptor = new CsvToExcelConverterPropertyDescriptor(srcDescriptor, resourceManager);
